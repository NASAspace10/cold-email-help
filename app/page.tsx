...
export default function Home() {
  ...
  useEffect(() => {
    if (!userId || stage !== "tickets") return;
  ...
  if (stage === "welcome") return (
    <div style={styles.homePage}>
      ...
      <div style={styles.homeHero}>
        ...
        <button style={styles.homeBtn} onClick={() => setStage("name")}>Open a Ticket</button>
      </div>
    </div>
  );
    ...
    <div style={styles.wrap}>
      ...
      <div style={styles.sidebar}>
        ...
        {chats.map((chat, i) => (
          <div
            key={chat.id}
            onClick={() => { setSelectedChatId(chat.id); setStage("tickets"); }}
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  homeHero: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "24px", padding: "48px 24px", textAlign: "center" },
